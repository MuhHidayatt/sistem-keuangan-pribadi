...
<body>
  <!-- Footer -->
  <footer class="main-footer" style="background-color: #343a40; color: #ffffff; padding: 20px 15px;">
    <div class="container">
      <div class="row">
        <!-- Left Section -->
        <div class="col-md-6 text-left">
          <strong>Muhammad Hidayat &copy; 2025</strong>
          <p style="margin: 5px 0;">Sistem Informasi Keuangan Pribadi</p>
        </div>
      </div>
    </div>
  </footer>
